        ...
        <div className="w-full max-w-md mx-4">
          <div className="bg-white rounded-2xl shadow-2xl p-12">
            ...
            <button
              ...
              type="button"
              className="w-full bg-white border-2 border-gray-300 text-gray-700 font-bold py-4 px-6 rounded-lg hover:bg-gray-50 hover:border-gray-400 hover:-translate-y-0.5 hover:shadow-xl transition-all duration-200 flex items-center justify-center gap-3"
            >
